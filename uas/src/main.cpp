...
int main( void )
{
	...
	*/
	...
	GLuint TextureParticle = loadDDS("model/particle.DDS");
	...
	do{
		...
		*/
		...
		for(int i=0; i<newparticles; i++){
			...
			ParticlesContainer[particleIndex].a = (255) / 3;
		...
		*/
		...
		// 5th attribute buffer : positions of particles' centers
		...
		// 6th attribute buffer : particles' colors
